                            ...
                            @foreach ($cart as $id => $details)
                                ...
                                <li class="flex py-6">
                                    <div class="flex-shrink-0">
                                        @if ($details['gambar'])
                                            <img src="{{ asset('storage/' . $details['gambar']) }}" alt="{{ $details['nama_menu'] }}" class="h-24 w-24 rounded-md object-cover object-center sm:h-32 sm:w-32">
                                        @else
                                            <img src="https://placehold.co/128x128/CCCCCC/FFFFFF?text=Menu" alt="{{ $details['nama_menu'] }}" class="h-24 w-24 rounded-md object-cover object-center sm:h-32 sm:w-32">
                                        @endif
                                    </div>
